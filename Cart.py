...
"""
cart = addtocard("Headphone", 1)
cart = addtocard("Headphone", 2)
cart = addtocard("Phone", 1)
print(cart)
cart = deletefromcart("Phone")
print(cart)
cart = increase("Headphone", 3)
print(cart)
cart = increase("Charger", 1)
print(cart)
cart = decrease("Headphone", 2)
print(cart)

  def addtocard(item, quality):
        if item in productname:
            index = productname.index(item)
            productquality[index] = productquality[index]+quality
        else:
            productname.append(item)
            productquality.append(quality)
        return dict(zip(productname, productquality))
    # ------------------------------------------------------------------------
    def deletefromcart(item):
        if item in productname:
            productname.remove(item)
        return dict(zip(productname, productquality))
    # ------------------------------------------------------------------------
    def increase(item,number):
        if item in productname:
            index = productname.index(item)
            productquality[index] = productquality[index] + number
        else:
            print("You don't have this product on your cart")
        return dict(zip(productname, productquality))
    # ------------------------------------------------------------------------
    def decrease(item,number):
        if item in productname:
            index = productname.index(item)
            productquality[index] = productquality[index] - number
        else:
